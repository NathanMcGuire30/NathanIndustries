...
public class MakeBigTree2 extends WorldGenAbstractTree {
	/**
	...
	public MakeBigTree2(boolean p_i45461_1_, Block trunk, Block leaves, int meta) {
		super(p_i45461_1_);
	...
	void placeLeafBlocks(int p_150529_1_, int p_150529_2_, int p_150529_3_, float p_150529_4_, byte p_150529_5_, Block leaves) {
	...
	void generateLeafNode(int p_76491_1_, int p_76491_2_, int p_76491_3_) {
		...
		for (int i1 = p_76491_2_ + this.leafDistanceLimit; l < i1; ++l) {
			...
			this.placeLeafBlocks(p_76491_1_, l, p_76491_3_, f, (byte) 1, this.leavesBlock);
		}
	}

	void placeTrunkBlocks(int[] p_150530_1_, int[] p_150530_2_, Block trunk) {
	...
	void generateTrunk() {
		...
		this.placeTrunkBlocks(aint, aint1, this.trunkBlock);
	...
	void generateLeafNodeBases() {
		...
		for (int[] aint = new int[] { this.basePos[0], this.basePos[1], this.basePos[2] }; i < j; ++i) {
			...
			if (this.leafNodeNeedsBase(k)) {
				this.placeTrunkBlocks(aint, aint2, this.trunkBlock);
			}
		}
	}
